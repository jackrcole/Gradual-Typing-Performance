...
declare module ts {
    ...
    const enum SyntaxKind {
        ...
        DeclareKeyword = 113,
        FloatNumberKeyword = 114,
        GetKeyword = 115,
        IntNumberKeyword = 116,
        ModuleKeyword = 117,
        RequireKeyword = 118,
        NumberKeyword = 119,
        SetKeyword = 120,
        ...
        ArrayLiteralExpression = 144,
        ObjectLiteralExpression = 145,
        PropertyAccessExpression = 146,
        ElementAccessExpression = 147,
        CallExpression = 148,
        NewExpression = 149,
        TaggedTemplateExpression = 150,
        TypeAssertionExpression = 151,
        ParenthesizedExpression = 152,
        FunctionExpression = 153,
        ArrowFunction = 154,
        DeleteExpression = 155,
        TypeOfExpression = 156,
        VoidExpression = 157,
        PrefixUnaryExpression = 158,
        PostfixUnaryExpression = 159,
        BinaryExpression = 160,
        ConditionalExpression = 161,
        TemplateExpression = 162,
        YieldExpression = 163,
        OmittedExpression = 164,
        TemplateSpan = 165,
        Block = 166,
        VariableStatement = 167,
        EmptyStatement = 168,
        ...
        ExternalModuleReference = 196,
        CaseClause = 197,
        DefaultClause = 198,
        HeritageClause = 199,
        CatchClause = 200,
        PropertyAssignment = 201,
        ShorthandPropertyAssignment = 202,
        EnumMember = 203,
        SourceFile = 204,
        Program = 205,
        SyntaxList = 206,
...
declare module ts {
    ...
    function createSourceFile(filename: string, sourceText: string, languageVersion: ScriptTarget, version: string, options: CompilerOptions, isOpen?: boolean): SourceFile;
